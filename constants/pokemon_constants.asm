...
STARTER_CHARMANDER EQU CHARMANDER
STARTER_SQUIRTLE   EQU SQUIRTLE
STARTER_BULBASAUR  EQU BULBASAUR

; rival starters
RIVAL_STARTER_JOLTEON    EQU 1
RIVAL_STARTER_FLAREON    EQU 2
RIVAL_STARTER_VAPOREON   EQU 3
RIVAL_STARTER_SQUIRTLE   EQU 4
RIVAL_STARTER_BULBASAUR  EQU 5
RIVAL_STARTER_CHARMANDER EQU 6
